...
const User = ({ orders }) => {
  ...
  return (
    <Typography align="center">
      <p>Hay {typeUser()} usuarios registrados como Conector </p>
      <p>Hay {typeUser()} usuarios registrados como Vendedor </p>
      <p>Hay {typeUser()} usuarios registrados como Comprador</p>
    </Typography>
